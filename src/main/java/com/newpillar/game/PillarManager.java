...
public class PillarManager {
   ...
   private Material getCageMaterial() {
      return switch (this.currentMapType) {
         case WOOL -> Material.GLASS;
         case NETHER -> Material.NETHER_BRICK_FENCE;
         case GLASS -> Material.GLASS;
         case VOID -> Material.BARRIER;
         case TNT -> Material.GLASS;
         case TRAP_DOOR -> Material.GLASS;
         case SEA -> Material.GLASS;
         case MOON -> Material.GLASS;
      };
   }
